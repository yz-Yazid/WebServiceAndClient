...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements mypackage.HelloWorldService {
    ...
    private java.lang.String HelloWord_address = "http://localhost:8080/services/HelloWord";
    ...
    public mypackage.HelloWorld getHelloWord(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.HelloWordSoapBindingStub _stub = new mypackage.HelloWordSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.HelloWordSoapBindingStub _stub = new mypackage.HelloWordSoapBindingStub(new java.net.URL(HelloWord_address), this);
                _stub.setPortName(getHelloWordWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080/services/HelloWord", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8080/services/HelloWord", "HelloWord"));
        }
